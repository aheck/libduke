 ...
 * bands. Sprites, game effects, palette lookup variants and exact Build
 * visibility are not yet implemented. Overlapping sectors are drawn together
 * with depth testing. Coordinates are (Build X / 1024, -Build Z / 16384, Build
 * Y / 1024).
